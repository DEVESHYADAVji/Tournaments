              ...
              <div className="nav-dropdown">
                ...
                <div className="dropdown-grid">
                  ...
                  <Link to="/payments" className="dropdown-item">
                    <span className="dropdown-item-title">Payments</span>
                    <span className="dropdown-item-text">Manage tournament entry payments and history.</span>
                  </Link>
                  {user?.role === 'admin' ? (
                    <>
                      ...
                      <Link to="/admin/copilot" className="dropdown-item">
                        <span className="dropdown-item-title">AI tournament copilot</span>
                        <span className="dropdown-item-text">Generate a validated tournament configuration draft.</span>
                      </Link>
                    </>
                  ) : null}
                </div>

...
const AppRoutes: React.FC = () => <Suspense fallback={<LoadingFallback />}><Routes>
  <Route path="/" element={<Home />} /><Route path="/tournaments" element={<Tournaments />} /><Route path="/tournaments/:id" element={<TournamentDetailsRoute />} /><Route path="/tournaments/:id/bracket" element={<Bracket />} /><Route path="/teams" element={<Teams />} /><Route path="/notifications" element={<Notifications />} /><Route path="/payments" element={<Payments />} /><Route path="/admin/copilot" element={<TournamentCopilot />} /><Route path="/profile" element={<Profile />} /><Route path="/ocr" element={<ImageTextExtractor />} /><Route path="/admin" element={<AdminRoute />} /><Route path="*" element={<Navigate to="/" replace />} />
</Routes></Suspense>;
